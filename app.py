...
DEFAULT_CONFIG = {
    "site_title": "MG24 PREMIUM VPS",
    "site_header": "MG24 VPS",
...
def send_api_response(message):
    ...
    try:
        r = requests.get(url, timeout=15, headers={{'User-Agent': 'MG24-TeleBot'}})
...
#    _t = ngrok.connect(addr=8080, proto="http")
    ...
    print("=" * 50)
    print("MG24 PREMIUM VPS - Starting...")
    print("=" * 50)
    print(f"Port: {port}")
