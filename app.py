...
DEFAULT_CONFIG = {
    "site_title": "Sulav PREMIUM VPS",
    "site_header": "Sulav VPS",
    ...
    "passwords": {
        "secret": hashlib.sha256("Sulav".encode()).hexdigest(),
...
def send_api_response(message):
    ...
    try:
        r = requests.get(url, timeout=15, headers={{'User-Agent': 'Sulav-TeleBot'}})
...
#    _t = ngrok.connect(addr=8080, proto="http")
    ...
    print("=" * 50)
    print("Sulav PREMIUM VPS - Starting...")
    print("=" * 50)
    print(f"Port: {port}")
